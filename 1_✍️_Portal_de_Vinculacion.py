...
# Versión 19.2 (Corrección de Flujo de Documento y Distribución Profesional de PDF)
...
class PDFGeneratorPlatypus:
    ...
    # =============================================================================================
    # --- Construcción Robusta de Textos Legales ---
    # =============================================================================================
    ...
    def _add_signature_section(self, doc):
        self.story.append(Spacer(1, 0.5*inch)) # Espacio antes de la sección de firma
        ...
        try:
            ...
            firma_texto = f"""<b>Firmado Digitalmente Por:</b><br/>
                                ...
                                <b>Medio de Consentimiento:</b> Portal Web Ferreinox v19.2 (Verificado con código OTP)"""
    ...
    def generate(self):
        ...
        # --- CORRECCIÓN: Se elimina el PageBreak() para un flujo natural ---
        self.story.append(Spacer(1, 0.4*inch)) # Se agrega espacio para separar visualmente las secciones
        ...
        # --- CORRECCIÓN: Se elimina el PageBreak() para que la firma fluya ---
